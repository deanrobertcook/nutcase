...
public class RunControllerTest {
    ...
    private static final Logger log = LoggerFactory.getLogger(RunControllerTest.class);
    ...
    public void testReadAll() throws Exception {
        ...
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/runs"))
                .andDo(print())
    ...
    public void testReadAllSorted() throws Exception {
        ...
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/runs?page=0&size=7&sort=name"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andExpect(jsonPath("$.content", hasSize(1)))
